    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (c.getCount() != 0) {
            if (c.moveToFirst()) {
                ...
                getDataFromDatabase("myFavouriteRecipes", myRecipes);
                ...
                myAdapter.setClickListener(new MyRecyclerViewAdapter.ItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        ((MainActivity) getActivity()).getSupportActionBar().setTitle(getActivity().getResources().getString(R.string.txt_favourite));
            ...
            view = inflater.inflate(R.layout.favourite_fragment, null);
